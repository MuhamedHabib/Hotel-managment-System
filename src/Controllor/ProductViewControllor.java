...
public class ProductViewControllor implements Initializable {
    ...
    public JFXButton btn_chart;
    @FXML
    private Button toaddfile;
    @FXML
    private Button back;
    @FXML
    private TableView<offre> TableProduct;

    @FXML
    private TableColumn<offre, String> id;//id_file

    @FXML
    private TableColumn<offre, String> title;//id

    @FXML
    private TableColumn<offre, String> image;//file blob(contenu)

    @FXML
    private TableColumn<offre, String> price;//date_creation

    @FXML
    private TableColumn<offre, String> categ_id;
    @FXML
...
/********************//***********************/
    ...
    ObservableList<offre> formationList = FXCollections.observableArrayList();
    ...
    private void loadDate() {
        ...
        categ_id.setCellValueFactory(new PropertyValueFactory<>("category"));
                    ...
                    if (empty) {
                        ...
                        deleteIcon.setOnMouseClicked((javafx.scene.input.MouseEvent event) -> {
                            ...
                            try {
                                ...
                                query = "DELETE FROM `offre` WHERE id  ="+formation.getId();
                                connection = DbConnect.getConnect();
                                preparedStatement = connection.prepareStatement(query);
                        ...
                        editIcon.setOnMouseClicked((javafx.scene.input.MouseEvent event) -> {
                            ...
                            addFileController.setTextField(formation.getId(),formation.getTitle(),formation.getImage(),formation.getPrice(),null);
...
//ci dessous pour faire le call ADD scene
    ...
    public void actoin_chart(ActionEvent event)throws Exception {
